...
BEGIN_MESSAGE_MAP(CListCustomApp, CWinApp)
...
// 唯一一個 CListCustomApp 物件

CListCustomApp theApp;


// CListCustomApp 初始化

BOOL CListCustomApp::InitInstance()
{
